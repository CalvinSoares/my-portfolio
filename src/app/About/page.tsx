        ...
        <div className='flex flex-col justify-center items-center min-w-screen min-h-screen '>
            ...
            <div className='flex flex-col items-center justify-center'>
                ...
                <div className='flex text-center items-center justify-center mt-24'>
                    <Link href="/projects" className='border border-gray-200  rounded-full text-[#583ebc] mt-3 w-64 h-12 flex items-center justify-center hover:text-[#583ebc] hover:bg-gray-300 font-bold duration-200 hover:scale-110'>
