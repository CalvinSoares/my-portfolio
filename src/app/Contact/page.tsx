    ...
    <section id="Contact" className='bg-[#121212] '>   
        ...
        <div className='flex justify-center items-center min-w-screen min-h-screen '>
            ...
            <div className='flex flex-col justify-center text-center items-center h-full w-full mx-8 md:mx-2'>
                <div>
                    <h1 className='text-4xl md:text-7xl font-bold text-[white] my-2 hover:text-[#583ebc] duration-500 cursor-pointer'>Contact Me</h1>
                ...
                <div className="flex flex-col justify-center items-center mt-12">
                    <h1 className='self-start text-xl text-[#583ebc] font-bold '>Email</h1>
                    <CopyText text="calvinsoares19@gmail.com" />
                </div>
                <div className="flex flex-col justify-center items-center my-12">
                    <h1 className='self-start text-xl text-[#583ebc] font-bold '>Telephone</h1>
