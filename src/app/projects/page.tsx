...
const projectData = [
    {
        id: 1,
        title: "Banco Bet",
        description: "Front-end of an internal system for bank management of affiliate accounts through managing accounts. It included a login system with authentication and account management.",
...
export default function ProjectsSection() {
  ...
  return (
    <section id="Projects" className='min-w-full min-h-full flex flex-col justify-center bg-[#121212] '>
        ...
        <div className='p-12'>
            ...
            <ul  ref={ref} className='grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 cursor-pointer'>
                ...
                <div className='flex flex-col text-center items-center justify-center mt-24'>
                    <Link href="/Contact" className='border border-gray-200  rounded-full text-[#583ebc] mt-3 w-44 h-12 flex items-center justify-center hover:text-[#583ebc] hover:bg-gray-300 font-bold duration-200 hover:scale-110'>
                        Contacts
                    </Link>
