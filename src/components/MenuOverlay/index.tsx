...
export default function MenuOverlay({ isOpen, onClose }) {
  return (
    ...
    >
      <div
        className={`absolute top-0 left-0 right-0 bg-[#242424] p-8 transition-transform duration-300 ${isOpen ? "-translate-y-0" : "-translate-y-full"}`}
      >
        <div className="flex flex-col items-center space-y-6">
          ...
          <Link
            className="items-center flex justify-center w-full h-12 rounded-3xl hover:bg-[#583ebc] duration-300 cursor-pointer"
            href="/"
            onClick={onClose}
          >
            Home
